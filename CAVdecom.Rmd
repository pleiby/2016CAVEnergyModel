...
#DemScenParams$NIE = EnergyIntensityChange$NIE  # for matching VC, and Parameter=='I_deltaCAV'
#DemScenParams %>% filter(Parameter=="I_deltaCAV")
DemScenParams %>% gather(key = Sens, value = value, Low:Zero)  %>%
