...
!!! NOTE THIS VARIANT ENERGY INTENSITY (FUEL COST) FOR TEST!!: Energy Intensity Reduction is halved for TechScen 2 (for both LDVs and HDVs)
...
EnergyIntensityChangesX = EnergyIntensityChanges %>%
...
kable(scenCostData, caption="Table: Vehicle travel cost data [c/mi] for these test cases of alternative pooling.",
      digits=3)
```
