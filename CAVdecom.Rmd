...
header=TRUE,sep=":",strip.white=TRUE) #
# as in "='[CAV Energy ASIF Framework WadudMacKenzieLeiby V20161024Test20180325r1.xlsx]calcul Dem_LDV'!$A$35:$E$43" ('calcul Dem_LDV'!$A$39:$E$47 in later versions)
...
# RelTotCost = VTCShrAlt %>% filter(CostCat=="Total")
...
VMTIncrease = RelTotCost %>% filter(!(VC=="HDV" & Case=="High")) %>%
  select(-VehType) %>%
  group_by(VC, DemScen) %>%
...
DS2      :HDV  :0.15600896  :0.15600896  :Cost-base response (with ElasVKT) with Elderly multiplier effect option 1
DS3      :HDV  :0.42890465  :0.42890465  :Cost-base response (with ElasVKT) with Elderly multiplier effect option 3
DS4      :HDV  :0.68293679  :0.68293679  :Cost-base response (with ElasVKT) with Elderly multiplier effect option 4
...
DS6      :LDV  :0.67116428  :0.67116428  :scenario 5 with shift to carsharing
DS7      :LDV  :0.31982499  :0.31982499  :scenario 3 with shift to carsharing1
"),header=TRUE,sep=":",strip.white=TRUE) #
