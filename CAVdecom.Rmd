...
cat("Check: Test output to Kaya (VMTIncrease table) matches example for CombScen in",
...
Create dataframe of changes in Energy Intensity and Travel Demand, for all Combined Scenarios
```{r}
