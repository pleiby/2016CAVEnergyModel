...
temp <- temp %>%
  select("VC", "DemScen", "ElasCase", "TechScen",
         ...
         "old_fracVMTIncr", "old_fracEnergyUse", "old_EnergyUse",
         "fracVMTIncr",  "fracEnergyUse",  "EnergyUse",
...
temp = CaseAssumpsResults %>% mutate(testTEST_NIE = abs(I_deltaCAV - NIE)) %>% 
  select(VC, DemScen, ElasCase, TechScen, Automation, Fuel, Use, I_deltaCAV, NIE, testTEST_NIE, 
         ...
         old_fracVMTIncr, fracVMTIncr, old_fracEnergyUse, fracEnergyUse,
...
aggregateSelectedCaseAssumpsResults <- function(case_assumps_results, # df with precalc assumps & results
  ...
  case_assumps_results %>%
    ...
    mutate( # convert all result vars to versions weighted by joint FAU share
      ...
      # EnergyUse: this has already been weighted by joint shares of veh sub-types
...
barPlotScenarioSetIntVMTEnergy <- function(thisdata, 
  ...
  thisdata %>%
    ...
    gather(key = variable, value = calcValue, resultVars) %>%
