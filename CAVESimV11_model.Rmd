...
CombScenInputsAndResultsForOneTechScen <- function(CurrTS, CurrYr, demScensWanted) {
  ...
  VTCShrAlt <- left_join(VTCShrAlt, select(DemScenCostChange, -Description), by = c("DemScen")) # currently _not_ Sensitivity Case-dependent
...
CaseAssumpsResults <- CaseAssumpsResults %>%
  mutate(
    ...
    old_C_Fuel = C_Fuel,
    old_C_VNonF = C_VNonF,
    old_C_Time = C_Time, # C_Time at this point differentiated only by VC and DemScen
