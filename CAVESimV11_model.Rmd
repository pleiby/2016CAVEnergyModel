...
### 3.3 Plots of Energy Intensity Changes by Mechanism, and Scenario
...
mechsBarChart <- function(mechs_df, 
  ...
  mechs_df %>%
    ...
    gather(key = case, value = value, xlolim:uplim) -> temp_df
  # str(temp_df)
  ...
  temp_df %>%
    ...
    scale_fill_manual(values = c("steelblue", NA, "steelblue")) + # suppress the ploting of the lower/second bar
    coord_flip() +
