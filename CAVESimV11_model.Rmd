...
CombScenInputsAndResultsForOneTechScen <- function(CurrTS, CurrYr, demScensWanted) {
  ...
  # KLUDGE: duplicate column, w/o good names
  VTCShrAlt[,(ncol(VTCShrAlt)+1):(ncol(VTCShrAlt)+length(DetailedDemScens))] = VTCShrAlt$VTCost_shr
  names(VTCShrAlt) <- c(names(VTCShrBase), DetailedDemScens)
  #  mutate(
