...
Considering alternative such elasticities represents different logistical possibilities for pooled ride-hailing travel, 
and yields different insights about the economic opportunities for reducing VMT through pooling.
...
??? Are we at risk of confusing "occupancy" and (target) pooling or ridership level?
...
- $E(o) = E(o_1) \cdot o^{\epsilon_{Tour, o}}$

for varous values of the elasticity $\epsilon_{Tour, o}$
...
Numerical results for a range of Occupancy, Road Charge ($/VMT) and Route-length Elasticity

Time-cost is multiplied by a factor reflecting the disutility of pooling [unitless]:

$$m_{CT,o} = o^{\epsilon_{VoTT, o}}$$

- $m_{CT,o}$ = `TimeCostInflation`
