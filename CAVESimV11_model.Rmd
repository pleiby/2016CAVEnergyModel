...
temp <- CaseAssumpsResults %>%
  mutate(
    NIEratio = round(temp$NIE/temp$I_deltaCAV, 6)
  )
...
```{r echo=echoWorking}
table(temp$Automation, temp$NIEratio)
```
...
```{r echo=echoWorking}
table(temp$TechScen, temp$NIEratio)
```
