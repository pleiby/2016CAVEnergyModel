...
```{r}
tableScenarioSetIntVMTEnergy(
  CaseWantedAggAssumpsPrivateCAV, 
...
barPlotScenarioSetIntVMTEnergy(CaseWantedAggAssumpsEVs,
                               title = "Fig: Energy-Intensity, VMT, and Energy Scenarios",
...
CaseWantedAggAssumpsPrivateMV <- aggregateSelectedCaseAssumpsResults(
  CaseAssumpsResults, 
  select(CombScen_Combinations_subset, -Notes),
  # auto_set = c("No", "Partial", "Full")
  auto_set = c("No"),
...
barPlotScenarioSetIntVMTEnergy(CaseWantedAggAssumpsPrivateMV,
                               title = "Fig: Energy-Intensity, VMT, and Energy Scenarios",
...
```{r}
tableScenarioSetIntVMTEnergy(
  CaseWantedAggAssumpsPrivateMV, 
  tablecaption = "Private, Non-Automated Vehicles")
```

```{r testCasesForSelectedSegments5, echo=echoWorking, dpi=300, fig.width=7, fig.height=7}
CaseWantedAggAssumpsPrivateGasMV <- aggregateSelectedCaseAssumpsResults(
  CaseAssumpsResults, 
  select(CombScen_Combinations_subset, -Notes),
  # auto_set = c("No", "Partial", "Full")
  auto_set = c("No"),
...
barPlotScenarioSetIntVMTEnergy(CaseWantedAggAssumpsPrivateGasMV,
                               title = "Fig: Energy-Intensity, VMT, and Energy Scenarios",
...
```{r}
tableScenarioSetIntVMTEnergy(
  CaseWantedAggAssumpsPrivateGasMV, 
