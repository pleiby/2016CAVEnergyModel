...
```{r dualOccupancyPlot, echo=echoWorking, dpi=300, fig.width=5, fig.height=3.0}
...
grid.arrange(plt1, plt2, # + rremove("x.text"), 
             ncol = 2, nrow = 1)
