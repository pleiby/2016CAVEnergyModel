...
temp %>%
  ...
  geom_histogram(aes(fill=Automation), 
                   ...
                   col="black", 
                   size=.1) +  # change binwidth
  labs(title="Histogram of Fractional Energy Change Increase Over Cases", 
...
temp %>% # Note: no Full Auto Private Gas vehicles were altered
  ...
  filter(testTEST) %>% 
  pull(testEnergy) -> testEnergy
cat(
  "Check: Maximum observed difference in EnergyUse, disagg vs agg, is",
  paste(max(testEnergy)), ".\n"
)
