...
date: Rev. 2019-11-26, Printed `r Sys.Date()`
output:
  word_document:
    df_print: kable
    fig_caption: yes
...
SetK_Mechs <- c( # mechanisms k by which automation alters energy and/or demand
  ...
  # Demand Mechanism set ncludes these
...
mechScenAssumps <- read_csv(paste0("./Data/", "CAV_Scenario_Descriptions.csv"), comment = "#")
...
**Note**: This is actually ElasPKT, which equals ElasVKT for fixed occupancy at the reference level. ElasVKT will vary with occupancy.
