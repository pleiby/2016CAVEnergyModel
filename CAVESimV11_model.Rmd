...
occupancyEffects1 <- occupancyEffects1 %>%
  mutate(
    ...
    PoolTimeCostInflation = o^Elas_VoTT_wrt_Pooling, # Time-cost multiplier due to disutility of pooling [unitless]
    PoolTourContraction = o^Elas_TourLength_wrt_Pooling,
...
calcPoolingEnergyCases <- function(dfVMT,
