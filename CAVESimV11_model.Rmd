...
Tabulate assumptions and results for selected Combined Scenarios in `CaseWantedAssumpsResults`.
...
scenDisaggData <- CaseWantedAssumpsResults %>%
  filter(
...
### Review of Data Transformations
    ...
    AggAssumpsResults %>% {DemScenWanted,ElasCaseWanted, VehClassWanted} %>% scenAggData
    AggAssumpsResultsDAVT %>% {DemScenWanted,ElasCaseWanted, VehClassWanted} %>% scenAggDataDAVT
    C_tot_base <- extractVehTotalTravelCost(VTCostBase, VehTypeWanted, "Total" ) # total base travel cost, c/mi
