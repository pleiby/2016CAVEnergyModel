...
CombScen	VC	fracVMTIncr	NIE	EnergyUse	tstEnergyUse	totshare
CS_B_High	HDV	0.1360	0	0.1360	0.1360	0.0400
CS_B_High	LDV	0.2560	0	0.2560	0.2560	0.1132
CS_Base	HDV	0.0000	0	0.0000	0.0000	0.0000
CS_Base	LDV	0.0000	0	0.0000	0.0000	0.0019
CS_C_High	HDV	0.2339	0	0.2339	0.2339	0.0400
CS_C_High	LDV	0.3853	0	0.3853	0.3853	0.1374
...
prepAltVMT2 %>%
  ...
  scale_color_brewer(type = "seq", palette = "Blues") + # setting color of lines?
  ggtitle("Energy (For Ride-Hailing Travel) Decrease with Pooling and Road Charge") +
