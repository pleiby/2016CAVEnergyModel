...
# Calculated VoTT for LDV average value matches VMT-weighted average of local and intercity

#  "VoTT.LDV", "average" =
#     ("VMTtot.LDV", "local"] * "VoTT.LDV", "local"] +
#       "VMTtot.LDV", "intercity"] * ["VoTT.LDV", "intercity"]) /
#       (["VMTtot.LDV", "local"] + TravTimeCostBasePars["VMTtot.LDV", "intercity"])
...
# average_TTC_per_mi = VoTT / average_speed # for V_Class = LDV, HDV, region = local, intercity, average

# Calculated Average TTC per mile for LDV average value matches VoTT/speed to within",
...
# Calculated Average TTC per mile for HDV average value matches VoTT/speed to within",
