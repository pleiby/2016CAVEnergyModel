...
```{r echo=echoWorking}
table(temp$Automation, round(temp$NIE/temp$I_deltaCAV, 4))
```

```{r echo=echoWorking}
table(temp$Use, round(temp$NIE/temp$I_deltaCAV, 4))
```


```{r echo=echoWorking}
table(temp$Fuel, round(temp$NIE/temp$I_deltaCAV, 4))
```
