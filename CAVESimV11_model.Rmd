...
based on historical information about the elaticity of vehicle fuel economy.
...
nieForScenYear <- function(EIChanges, TechScenWanted, YearWanted) {
  EIChanges %>%
    ...
    select(VC, NIE) # leaves and returns a small df with net intensity changes for each vehicle class
}
```
