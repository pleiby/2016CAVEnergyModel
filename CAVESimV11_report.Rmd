...
abstract: A compact and aggregated model of road vehicle travel and energy use is
  ...
  consumption, and leisure, subject to individual budget and time constraints.
---
...
We construct Scenario Multipliers $\mu_{jtv}$ (supressing subscripts *m, f*) for the vehicle energy intensity of each Tech Scenario *j*, for Year *t* and Vehicle class *v*. These overall intensity multipliers for technology scenario *j* reflect the combined the effect of all the mechanisms on vehicle energy intensity.
