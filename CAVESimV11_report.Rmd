...
```{r summaryIntensityMechanisms, echo=echoWorking, dpi=300}
...
# IEffects$Mech = with(IEffects, factor(Mech, levels = rev(levels(Mech)))) # reverse alphabetic order 
IEffects %>%
#  select()
  mechsBarChart()
```

Repeat mechanisms bar chart with wider fig.width specification.
