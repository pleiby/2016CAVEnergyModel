...
3. **Estimate Effects on Road Travel Demand** (VKT, PKT)
  - Total Demand (PMT) response to $\Delta$ cost/convenience
...
- Summarize Key Response relationships*  [Rebound, VoTT, congestion effects]
...
# Connections to Other SMART Project Assumptions & Results
...
# CAVESIM Inputs to be Drawn From/Benchmarked to Detailed SMART Models/Studies
...
Energy use is the product of energy intensity *I* (Mj/km) and travel VMT *M* (km/yr):
...
\end {aligned}
$$
Note we also include some consideration (tracking) of societal (non-market) costs associated with fuel use *F* and VMT *M*. These include, e.g. air emissions, accidents, and congestion.
...
Fig: VMT vs. VMT Incr. Cost

## CAVESIM Connections to Task 2B and SMART Workflow

- **Connections to CAV 2B tasks**
    - Take aggregated National, or regional VMT and Energy (from given cases) as benchmark
