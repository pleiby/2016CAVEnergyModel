...
* $\Delta \delta_{kvi}$ is the incremental effect on demand (VMT) for effect *m* in demand scenario *j*, for vehicle type *v*
...
Based on utility maximization, with time and budget constraints.
