...
testAggregation <- CaseWantedAggEffects %>%
  ...
  select(-Year)
cat(
  "Check: Calculated aggregate `EnergyUse` changes match product of aggregate energy intensity `NIE` and VMT changes `fracVMTIncr` to within total absolute error ",
