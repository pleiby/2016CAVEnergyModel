...
# fredr_series_search_text(search_text = "Total Household") # - Search for a FRED series by text.
...
names(elas_Mv_Cv) = paste0("elas_o_Cv_", elas_o_Cv_vals)
...
VTCostAlt1 = VTCostAlt %>% dplyr::filter(
  DemScen == "DS3",
  VehType == "LDVAvgSedan"
  ) %>%
