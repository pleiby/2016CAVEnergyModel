...
Consider the size of the vehicle fleet, or parc, in the base case (Case 0). Assuming all vehicles are private (conventional?) in the Base Case:

$$ParcSize_0 \equiv N_{tot0} = N_{PV0}$$

This number of vehicles satisfies the base demand for rides/trips.
$$Rides_0 = 1*N_{tot0}$$

assuming "1" ride per private vehicle (i.e. private vehicle ride are normalized to 1.0)
