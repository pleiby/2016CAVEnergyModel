...
## Outline 1: Opportunities for Road Transport Carbon Reduction through Automation and Shared Mobility
...
4. Net implications for C emissions reduction
  - Some original quantitative estimates/insights
  - A review of other research in the literature.
  - Most of my discussion is U.S.-centric (alas), but extensible
5. Key Messages
...
## 1.1 Expected importance of (full, generlized costs)
  - and policy (re pricing and access)
  - show costs
...
## 1.2 Mechanisms and effects - Updated diagram

## 1.3 Demand effect
- types of demand responses
  - underserved groups
  - cost-based demand response
  - freight
  - pooling/sharing (defer to part 2)
  - short and long-run (land-use) implications
  
## 1.4 Value (Cost) of Travel Time
...
3.6:1                 |Peak travel hour, no pooling (congested, similar origins and destinations in rush hour)|Levin et al. 2017
...
- Simulation Studies show ride services meet 90%+ trip demand with "acceptable" delay and 7-12X reduction in vehicles
  - Fagnant & Kochelman etc XXX
