...
1. Estimated Effects of Automation on road travel, energy use, emissions
...
4. Net implications for C emissions reduction
5. Key Messages


## 1. Effects of Automation on road travel, energy use, emissions

### Expected importance of full (generalized) costs
...
## 1.2 Mechanisms and effects - Changing Energy Intensity and Travel Demand

```{r, echo=F, out.width='50%', fig.align='center', fig.cap='Multiple mechanisms can alter vehicle energy intensity and travel'}
...
- Evidence to date and on-going research
  - chauffer experiment
  - empirical work: 
    - using proxies for CAV
- results/insights for demand effect
...
## Estimates of the Household Vehicles Replacable by SAVs While Satisfing Demand
...
**Private:Shared Veh**| **Notes**             | **Source**
------------------|----------------------------|------------------------
...
17:1, 31:1           |Pooled SAVs. Peak est. in CBD, pooling of 3-4 |Johnson 2016, Levin et al. 2017

- but not necess fewer vehicles on the road or less VMT

## 2. Effect of Shared mobility on Travel (PMT) while mitigating Traffic (VMT)

#### Empirical data so far show large increase in VMT from TNCs

Study	|	Empty Fraction of Total TNC Miles	|	Comments
--------------------	|	--------------------	|	------------------------------
Henao & Marshall 2018	|	41%	|	"Conservative" Uber/Lyft Denver
Komanduri et al 2018	|	37%	|	RideAustin Dataset (incl. assumed 2 mile commute)
Cramer & Kreuger 2016	|	36%-45%	|	From Uber data in 5 cities, empty miles
Schaller 2017	|	40%	|	NYC Ridesourcing, NYC Taxi Commission data
SF County Transp. Authority 2017	|	20%	|	San Francisco city core, excl commuting, omits distance from request to pickup.
Wenzel et al. 2019	|	45%	|	RideAustin data, 26% for between-ride, 19% commuting.
Loeb et al 2018	|	20%	|	**Simulation** satisfying 40% of all trips under  50 miles in Austin

- Our estimates of pooling potential???
...
- Classic reasoning:
  ...
  - AVs make time/inconvenience of recharging
  - AVs have high "auxilliary feature" loads, amplifying the problem of EV energy management, exacerbating range problem
...
1. Automation is highly valuable and *market-driven*, hence likely in some form(s)
    - time, safety, convenience, cost
2. Automation can have profound effects on road travel, energy use, emissions
3. For "Shared mobility" to help, need pooling (higher occupancy)
4. Widespread (S)(A)Vehicle electrification can make a big difference. Has some advantages, but not assured.
...
6. Costs, incentives and policy matter
    - roadway/curb access priorities
    - road use charges
...
## Outline 2: (Potentially) Important areas I do not plan on addressing
