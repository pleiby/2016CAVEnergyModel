...
knitr::include_graphics(here(figureLocPath, "CAV_multiple_mechanisms_can_alter_intensity_and_activity_barV20191106wide.png"))
...
## 4. Net implications for Energy Use
...
- Source: Gohlke et al. 2019. CAV Energy Bounding Study.
...
2. Automation can have significant VMT and energy use effects from Induced Demand and Unoccupied Travel
3. For "Shared mobility" to help, need pooling (higher occupancy)
4. Widespread electrification can make a big difference. Has some advantages, but not assured.
