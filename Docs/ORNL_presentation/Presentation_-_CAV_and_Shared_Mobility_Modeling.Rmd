...
## Study of Ride-Pooling Potential Impacts on VKT, PKT
...
* **Ride‐Hailing and VKT**: Transportation Network
Companies (TNCs) are providing new mobility
services, but they may also be increasing vehicle-miles,
congestion and emissions
* **MOST** (Minimum Occupancy STandards) for
TNCs: New policy tool to encourage ride‐pooling
* **Case study** of the MOST concept: use
publicly available data from RideAustin TNC [in progress]



## Vehicle Minimum Occupancy Standards: Encouraging Ride Pooling
* Ride pooling and increased vehicle occupancy
identified as key requirements for achieving the full
benefits of new mobility systems
* Distinguish “ride pooling” from “ride‐hailing"
* Incentives for ride pooling can deter empty vehicle
kilometers, limit congestion, energy use, and
emissions
* Minimum Occupancy STandards (MOSTs)
  - flexibly establish a minimum ride‐weighted occupancy level across TNC fleets
* Related _draft_ regulations: California Clean Miles Standard
  + Targets for GHG emission reductions by TNCs per passenger mile by 2021, implementaiton by 2023

## Current Vehicle Occupancy by Type

```{r, echo=F, out.width='65%', fig.align='center', fig.cap='Average Vehicle Occupancy, Davis et al. 2017 Figure 8.1]'}
# Alternatively, Markdown syntax is ![alt text or image title](path/to/image)
knitr::include_graphics(here("Docs", "ORNL_presentation", "figures", "Figure1_Average_Vehicle_Occupancy.png"))
```

## Approach

* We develop a model for MOSTs, identify efficient design considerations and *ideal* data needs
...
* With our proposed MOSTs, the regulated or controlled
component is vehicle occupancy, not the level of
transportation services that is free to vary with demand.
    - Intensity standards do not place a firm cap on the
regulated entity.
